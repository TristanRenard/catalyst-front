...
export default function LobbyPage() {
  ...
  const {
    ...
    handlers: {
      ...
      onQueueLeft: () => {
        console.log('File quittée')
        setLobbyState('idle')
        setQueueSize(0)
      },
      onMatchFound: (payload: MatchFoundPayload) => {
        console.log('Match trouvé:', payload)
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {lobbyState === 'idle' && (
          <div className="space-y-6">
            {/* Quick Match */}
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 shadow-2xl">
              <h2 className="text-2xl font-bold text-white mb-4">🎮 Partie Rapide</h2>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 shadow-2xl">
              ...
              {/* Create Room */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-white mb-2">Créer une salle</h3>
                <p className="text-white/80 mb-4 text-sm">
                  Créez une salle privée et partagez le code avec un ami
                </p>
                <button
        ...
        {lobbyState === 'match_found' && opponent && (
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 shadow-2xl">
            <div className="text-center">
              ...
              <div className="text-white/80 mb-6">
                La partie va démarrer dans quelques secondes...
              </div>
            </div>
          </div>
        )}
